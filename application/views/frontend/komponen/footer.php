...
<a href="index-2.html"><img src="<?= base_url('assets/frontend/img/logo/g1230.png')?>" alt=""></a>
</div>
<div class="footer-tittle">
<div class="footer-pera">
<p>Pondok Pesantren Mahasiswa Nur Baiturrahman.</p>
</div>
</div>
...
<p>
Copyright &copy;<script>document.write(new Date().getFullYear());</script> Devlop by <i class="fa fa-heart" aria-hidden="true"></i> by <a href="https://instagram.com/riczky_f" target="_blank">Fadilah Riczky</a>
</p>
</div>
</div>
</div>
...
<script src="<?= base_url('assets/frontend/js/animated.headline.js')?>"></script>
<script src="<?= base_url('assets/frontend/js/jquery.magnific-popup.js')?>"></script>

<script src="<?= base_url('assets/frontend/js/gijgo.min.js')?>"></script>
...
<script src="<?= base_url('assets/frontend/js/jquery.barfiller.js')?>"></script>
...
<script src="<?= base_url('assets/frontend/js/hover-direction-snake.min.js')?>"></script>
